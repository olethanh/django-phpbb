...
urlpatterns = patterns('',
    ...
    (r'^tematy/(?P<topic_id>[0-9]+)/(?P<slug>[\w-]*)/page(?P<page>[0-9]+)/$', 'atopowe.phpbb.views.topic', ),
    (r'^tematy/(?P<topic_id>[0-9]+)/(?P<slug>[\w-]*)/$', 'atopowe.phpbb.views.topic', ),
    (r'^(?P<forum_id>[0-9]+)/(?P<slug>[\w-]*)/$', 'atopowe.phpbb.views.forum_index', ),
    (r'^(?P<forum_id>[0-9]+)/(?P<slug>[\w-]*)/page(?P<page>[0-9]+)/$', 'atopowe.phpbb.views.forum_index', ),
    (r'^(?P<forum_id>[0-9]+)/$', 'atopowe.phpbb.views.forum_index', {'slug': ''}),
